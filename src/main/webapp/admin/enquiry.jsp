					...
					<div class="bg-light border-bottom-0 pt-4" id="sidebar-wrapper">
						...
						<div class="list-group px-4 mx-3">
							...
							<a href="${pageContext.request.contextPath}/admin/enquiry.jsp"
								...
								alt=""> <span class="pl-2 active">Enquires</span> <i
								class="fal fa-angle-right text-right"></i>
							</a>
			...
			<div class="container-fluid col-10 h-100">
				<div class="row my-4">
					...
					<div
						...
						<div class="d-flex">
							<img src="${pageContext.request.contextPath}/images/enquires.svg"
								alt="">
							<h5 class="pl-2 mt-2">Enquires</h5>
						</div>
					</div>
				</div>
							...
							<div class="body">
								<div class="table-responsive">
									<table id="enquiry-table"
										class="enqtable table table-bordered table-striped table-hover js-basic-example dataTable">
										<thead>
											<tr>
												...
												<th style="white-space: nowrap;">Skype Id</th>
												<th style="white-space: nowrap;">Whatsapp Number</th>
											</tr>
										</thead>
										<tbody id="contactinfoList">
										</tbody>
									</table>
								</div>
							</div>
