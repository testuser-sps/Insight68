					...
					<div class="bg-light border-bottom-0 pt-4" id="sidebar-wrapper">
						...
						<div class="list-group px-4 mx-3">
							...
							<a href="${pageContext.request.contextPath}/admin/admintryforfree.jsp"
								...
								alt=""> <span class="pl-2 active">Tryforfree</span> <i
								class="fal fa-angle-right text-right"></i>
							</a>
			...
			<div class="container-fluid col-10 h-100">
				<div class="row my-4">
					...
					<div
						...
						<div class="d-flex">
							<img src="${pageContext.request.contextPath}/images/try@2x.svg"
								alt="">
							<h5 class="pl-2 mt-2">Tryforfree</h5>
						</div>
					</div>
				</div>
									...
									<table id="tryforfree-table"
										class="table table-bordered table-striped table-hover js-basic-example dataTable">
											...
											<tr>
												...
												<th style="white-space: nowrap;">Working Field</th>
												<th style="white-space: nowrap;">Working as a</th>
												<th style="white-space: nowrap;">Domain</th>
												<th style="white-space: nowrap;">No.of Emp</th>
											</tr>
										</thead>
										<tbody id="tryforfreeList">
										</tbody>
									</table>
								</div>
							</div>
				...
				<div class="col-12 d-flex my-3 footer">
					...
					<div class="offset-4 col-4 text-right">
						<a href="#" class="footer-text not-allow">Terms of Service</a> <span
							class="footer-text">|</span> <a href="#" class="footer-text not-allow">Privacy</a>
					</div>
				</div>
