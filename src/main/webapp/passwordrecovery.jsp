				...
				<div class="row mt-5">
					<div class="col-lg-9 offset-lg-2 text-center">
						...
						<p class="navy step2-title">
							Hi <strong>Alent Desosa!</strong> Please check your mail.
						</p>
						...
						<p class="mt-2">
							Click the link in the email to recover your password and start
							growing with <strong> Insight68</strong> today.
						</p>
						...
						<a
							...
							<img class="mb-1" src="images/mail.svg" alt=""> Go To Mail
						</a>
